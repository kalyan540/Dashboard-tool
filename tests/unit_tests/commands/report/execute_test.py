...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ["url1", "url2"],
            [
                "http://0.0.0.0:8080/dashboard/p/url1/",
                "http://0.0.0.0:8080/dashboard/p/url2/",
            ],
        ),
...
def test_get_dashboard_urls_with_exporting_dashboard_only(
    ...
    assert "http://0.0.0.0:8080/dashboard/p/url1/" == result[0]
...
def test_get_tab_urls(
    ...
    assert result == [
        "http://0.0.0.0:8080/dashboard/p/uri1/",
        "http://0.0.0.0:8080/dashboard/p/uri2/",
    ]
...
def test_get_tab_url(
    ...
    assert result == "http://0.0.0.0:8080/dashboard/p/uri/"
